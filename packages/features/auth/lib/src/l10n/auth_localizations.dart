...
abstract class AuthLocalizations {
  ...
  /// No description provided for @numberInputInstruction.
  ///
  /// In en, this message translates to:
  /// **'Enter your phone number'**
  String get numberInputInstruction;

  /// No description provided for @pickCountryLabel.
  ///
  /// In en, this message translates to:
  /// **'Pick a country'**
  String get pickCountryLabel;
  ...
  /// No description provided for @numberVerificationTitle.
  ///
  /// In en, this message translates to:
  /// **'Verifying your number'**
  String get numberVerificationTitle;

  /// No description provided for @otpPromptMessage.
  ///
  /// In en, this message translates to:
  /// **'We have sent an SMS with code'**
  String get otpPromptMessage;
